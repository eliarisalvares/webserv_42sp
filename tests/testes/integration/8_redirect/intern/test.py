...
assert "<title>42 - Webserv</title>" in response.text

URL_BASE = "http://localhost:9000/"
URL_PRE_REDIR = URL_BASE + "test/index.html"
...
assert response.url == URL_POS_REDIR
assert response.status_code == 200
assert "<title>WebWizards</title>" in response.text
